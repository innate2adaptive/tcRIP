...
seqsC[0]=dp.filtr(seqsC[0], length)
seqsC[1]=dp.filtr(seqsC[1], length)  

# its handy to have the look up dictionaries for 
Prob4, dl4=positionProb(seqsC[0], length, intDictzero)
Prob8, dl8=positionProb(seqsC[1], length, intDictzero)

seqsC[0]=np.concatenate((charForProb(seqsC[0],dl4),charForProb(seqsC[0],dl8)),1)
seqsC[1]=np.concatenate((charForProb(seqsC[1],dl4),charForProb(seqsC[1],dl8)),1)


# use function to create data
X_1, y = dp.dataCreator(seqsC[0],seqsC[1])
