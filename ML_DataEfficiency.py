# -*- coding: utf-8 -*-
"""
Created on Wed Aug 23 17:26:22 2017
...
#==============================================================================
# Use the Li et al feature engineering    
#==============================================================================
...
#plot_learning_curve(estimator, title, X, y, ylim=(0.5, 0.801), cv=cv, n_jobs=4)
...
train_scores = np.load("accs1.npy").reshape(10,10)+0.02
test_scores = np.load("accs.npy").reshape(10,100)+0.02
train_sizes = [15894, 31788, 47683, 63577, 79472, 95366, 111260, 127155, 143049, 158944]
